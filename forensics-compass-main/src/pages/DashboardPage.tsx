...
import { MessageSquare, Phone, Users, Image, AlertTriangle, Globe, Wallet, Shield, Search, Calendar, MapPin, Brain, FileText, BarChart3 } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        <h2 className="text-lg font-bold font-mono text-primary cyber-text-glow">Advanced Investigation Tools</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link to="/timeline">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer cyber-border">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Advanced timeline with zoom, filters, and interactive event exploration
                </p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/chat">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer cyber-border">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Intelligent analysis with pattern recognition and conversation history
                </p>
              </CardContent>
            </Card>
          </Link>

          <Card className="hover:shadow-lg transition-shadow cursor-pointer cyber-border opacity-75">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2 text-base">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Interactive maps with location clustering and movement analysis
              </p>
          ...
          <Link to="/report">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer cyber-border">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Customizable reports with charts and automated insights
                </p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/graph">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer cyber-border">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Interactive relationship mapping and network analysis
                </p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/images">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer cyber-border">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Advanced image forensics with metadata extraction
                </p>
              </CardContent>
            </Card>
          </Link>
